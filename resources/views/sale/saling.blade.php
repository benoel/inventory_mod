...
<script>
  ...
  function popup_print(){
    window.open('{{ url("printsale") }}/{{ $datadetail->sale_number }}','page','toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=0,width=750,height=600,left=50,top=50,titlebar=yes')
  }
